...
public interface DictionaryInterface <K, V>{
	/** Adds a new entry to the dictionary. If the given search key 
	  * already exists in the dictionary, replaces the value
	  * @param key: an object search key for the new entry
	  * @param value: an object associated with the given search key
	  * @return the replaced value or null if the value did not exist
	  * in the dictionary
	  */
	 ...
	 public V remove (K key);
	    ...
	    * @return the retrieved value or null if the value did not exist
	    * in the dictionary
	    */
