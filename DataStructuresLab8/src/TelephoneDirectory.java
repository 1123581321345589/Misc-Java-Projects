...
public class TelephoneDirectory {
	...
	try {
		...
		File cinemas = new File("src/Movies");
		...
		Name name = new Name("West Newton Cinema");
	
		System.out.println(theaterName + td.getPhoneNumber(name));
		...
		do {
			...
			Name two = new Name("searchName");
			if (searchName.equals("quit"))
				break;
			phoneNumber = td.getPhoneNumber(two);
			if (phoneNumber == null)
